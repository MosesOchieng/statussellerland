...
function Pricing({ onAction }: { onAction: (message: string) => void }) {
  ...
  const planDescriptions = ['Full access for 14 days, no card required', 'The complete toolkit for everyday social selling', 'Advanced tools for teams ready to grow'];
